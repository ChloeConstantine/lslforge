...
lslEventDescriptors = [
    ...
    ("final_damage",[(LLInteger,"num_detected")], EventDeliveryScript, [],
     "Experimental event only available in some testing regions (soon). This event is triggered after all on_damage events in all scripts and attachments have processed and damage has been applied to the avatar or distributed to all seated avatars."),
    ...
    ("on_damage",[(LLInteger,"num_detected")], EventDeliveryScript, [],
     "Experimental event only available in some testing regions (soon). This event is triggered when damage has been inflicted on an avatar or task in the world but before damage has been applied or distributed."),
