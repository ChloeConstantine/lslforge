...
funcSigs = [
    ...
    ("llLinkParticleSystem",LLVoid,[LLInteger,LLList,LLInteger]),
    ("llLinkPlaySound",LLVoid,[LLInteger,LLString,LLFloat]),
...
funcDescriptions = [
    ...
    ("llLinkAdjustSoundVolume",(["link","volume"],"adjusts volume of attached sound (0.0 - 1.0) for the prim(s) link.\n")),
    ...
    ("llLinkPlaySound",(["link","sound","volume","flags"],"plays attached sound once at volume (0.0 - 1.0)\n")),
    ("llLinkSetSoundQueueing",(["link","queue"],"determines whether attached sound calls wait for the current sound to finish (0 = no [default], nonzero = yes)\n")),
    ...
    ("llLinkStopSound",(["link"],"Stops currently attached sound\n")),
