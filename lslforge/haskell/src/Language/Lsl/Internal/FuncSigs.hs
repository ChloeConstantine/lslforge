...
funcSigs = [
    ...
    ("llLinksetDataDataDelete",LLInteger,[LLString]),
    ("llLinksetDataDataDeleteProtected",LLInteger,[LLString,LLString]),
    ("llLinksetDataFindKeys",LLList,[LLString,LLInteger,LLInteger]),
    ("llLinksetDataListKeys",LLList,[LLInteger,LLInteger]),
    ("llLinksetDataDataRead",LLString,[LLString]),
    ("llLinksetDataDataReadProtected",LLString,[LLString,LLString]),
